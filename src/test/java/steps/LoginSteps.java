...
public class LoginSteps extends CommonMethods {
    ...
    public void user_is_navigated_to_hrms_application() throws InterruptedException {
        ...
        openBrowserAndLaunchApplication();// we are calling the method, it instead of using the above code. calling from common methods
    }

    @When("user enter admin username and password")
    public void user_enter_admin_username_and_password() throws InterruptedException {
